...
export default function EditTimeline() {
    ...
    const beatAnimation = {
        bounce: {
            ...
            transition: {
                duration: 0.35,
                ease: [0.16, 1, 0.3, 1] // <--- Операнд 'as const' повністю прибирає помилку TS
            }
        }
    };
    return (_jsx("div", { className: "edit-container", children: _jsxs("div", { className: "tiktok-viewport", children: [_jsx("div", { className: "anime-glow-filter" }), _jsx("div", { className: "vignette" }), _jsx(AnimatePresence, { children: isBeat && (_jsx(motion.div, { initial: { opacity: 0.6 }, animate: { opacity: 0 }, exit: { opacity: 0 }, transition: { duration: 0.15 }, className: "flash-layer" })) }), _jsxs(motion.div, { className: "glitch-wrapper", variants: beatAnimation, animate: "bounce", children: [_jsx("div", { className: `edit-frame rgb-red ${isBeat ? 'rgb-red-trigger' : ''}`, style: { backgroundImage: `url(${IMAGES[currentIndex]})` } }), _jsx("div", { className: `edit-frame rgb-blue ${isBeat ? 'rgb-blue-trigger' : ''}`, style: { backgroundImage: `url(${IMAGES[currentIndex]})` } }), _jsx("div", { className: "edit-frame rgb-main", style: { backgroundImage: `url(${IMAGES[currentIndex]})` } })] }), _jsx("div", { className: "edit-overlay-text", children: _jsxs(motion.h2, { animate: {
                            scale: isBeat ? [1.25, 0.9, 1] : 1,
                            skewX: isBeat ? [15, -10, 0] : 0
                        }, transition: { duration: 0.25, ease: "easeOut" }, children: [transitionIndex === 0 && "🎂 З Днем Народження! 🎂", transitionIndex === 1 && "❤️ Нехай всі мрії здійсняться ❤️", transitionIndex === 2 && "👑 QUEEN 👑"] }) })] }) }));
}
